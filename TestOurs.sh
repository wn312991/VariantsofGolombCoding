...
do
	...
	gcc -Wall -I /home/wn/gsl2.4/include/ -c -O3 -D PASSED_M=$M -D PASSED_b=$b Ours.c -lm -mlzcnt -o ours.o
	gcc -L /home/wn/gsl2.4/lib ours.o -lgsl -lgslcblas -O3 -lm -mlzcnt -o ours.out
	./ours.out
